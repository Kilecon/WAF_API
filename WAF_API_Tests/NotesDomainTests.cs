namespace WAF_API_Application.Tests
{
    ...
    public class NotesDomainTests
    {
        ...
        {
            // Arrange
            var cmd = new CreateNoteCmd { Title = "Valid Title.", Description = "Valid Description." };
        ...
        {
            // Arrange
            var cmd = new UpdateNoteCmd { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b34a", Title = "Updated Title", Description = "Updated Description.", IsChecked = true };
        ...
        {
            // Arrange
            var cmd = new UpdateNoteCmd { Id = "12345", Title = "Valid.", Description = "Updated Description.", IsChecked = true };
