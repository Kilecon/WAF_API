namespace WAF_API_Tests
{
    ...
    public class CommentsPrésentationTests
    {
        ...
        //    {
        //        new CommentDto { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b34a", Sentence = "Test Comment 1.", Description = "Description 1." },
        //        new CommentDto { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b36a", Sentence = "Test Comment 2.", Description = "Description 2." }
        //    };
        ...
        //{
        //    // Arrange
        //    var comment = new CommentDto { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b34a", Sentence = "Test Comment.", Description = "Description." };
        ...
        //{
        //    // Arrange
        //    var newComment = new CreateCommentCmd { Sentence = "New Comment.", Description = "New Description." };
        //    var createdComment = new CommentDto { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b34a", Sentence = "New Comment.", Description = "New Description." };
        ...
        //    Assert.Equal("New Comment.", returnValue.Sentence);
        ...
        //    var createdComment = new CommentDto { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b34a", Sentence = "Test Comment.", Description = "Test Description." };
        //    _mockCommentService.Setup(service => service.CreateAsync(It.IsAny<CreateCommentCmd>())).ReturnsAsync(createdComment);
        ...
        //    var returnValue = (CommentDto)actionResult.Value;
        //    Assert.Equal("7af6dfb8-aaf7-4ed6-ab2c-c7635c79b34a", returnValue.Id);
        //    Assert.Equal("Test Comment.", returnValue.Sentence);
        ...
        //{
        //    // Arrange
        //    var updateCommentCmd = new UpdateCommentCmd { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b34a", Sentence = "Updated Comment.", Description = "Updated Description." };
