namespace WAF_API_Tests
{
    ...
    public class NotesPrésentationTests
    {
        ...
        public async Task GetNotes_ReturnsOk_WhenNotesExist()
        {
            ...
            {
                new ChallengeDto { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b34a", Title = "Test Note 1.", Description = "Description 1." },
                new ChallengeDto { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b36a", Title = "Test Note 2.", Description = "Description 2." }
            };
        ...
        {
            // Arrange
            var comment = new ChallengeDto { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b34a", Title = "Test Note.", Description = "Description." };
        ...
        {
            // Arrange
            var newNote = new CreateNoteCmd { Title = "New Note.", Description = "New Description." };
            var createdNote = new ChallengeDto { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b34a", Title = "New Note.", Description = "New Description." };
            ...
            Assert.Equal("New Note.", returnValue.Title);
        ...
        public async Task CreateNote_ReturnsCreated_WhenEmptyCommand()
        {
            ...
            var createdNote = new ChallengeDto { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b34a", Title = "Test Note.", Description = "Test Description." };
            _mockNoteService.Setup(service => service.CreateAsync(It.IsAny<CreateNoteCmd>())).ReturnsAsync(createdNote);
        ...
        {
            // Arrange
            var updateNoteCmd = new UpdateNoteCmd { Id = "7af6dfb8-aaf7-4ed6-ab2c-c7635c79b34a", Title = "Updated Note.", Description = "Updated Description.", IsChecked = true };
