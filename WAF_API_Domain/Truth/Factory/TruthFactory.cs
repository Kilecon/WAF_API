...
namespace WAF_API_Domain.Truth.Factory
{
    public class TruthFactory : ITruthFactory
    {
        public TruthAr CreateIntance(CreateTruthCmd cmd, string id)
        {
            try
            {
                return new TruthAr(new Id(id), new QuestionEn(cmd.QuestionEn), new QuestionFr(cmd.QuestionFr), new DifficultyName(cmd.DifficultyName));
        ...
        public TruthAr UpdateIntance(UpdateTruthCmd cmd)
        {
            try
            {
                return new TruthAr(new Id(cmd.Id), new QuestionEn(cmd.QuestionEn), new QuestionFr(cmd.QuestionFr), new Mark(cmd.Notation), new DifficultyName(cmd.DifficultyName));
