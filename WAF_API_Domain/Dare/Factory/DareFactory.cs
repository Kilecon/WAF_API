...
namespace WAF_API_Domain.Dare.Factory
{
    public class DareFactory : IDareFactory
    {
        public DareAr CreateIntance(CreateDareCmd cmd, string id)
        {
            try
            {
                return new DareAr(new Id(id), new QuestionEn(cmd.QuestionEn), new QuestionFr(cmd.QuestionFr));
        ...
        public DareAr UpdateIntance(UpdateDareCmd cmd)
        {
            try
            {
                return new DareAr(new Id(cmd.Id), new QuestionEn(cmd.QuestionEn), new QuestionFr(cmd.QuestionFr), new Notation(cmd.Rating));
